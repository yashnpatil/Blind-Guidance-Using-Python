...
if __name__ == '__main__':
	...
	if FLAGS.image_path:
		...
		try:
			...
			img, _, _, classids, _ = infer_image(net, layer_names, height, width, img, colors, labels, FLAGS)
			show_image(img)
			
			print(classids)
	
for i,j in zip(lables_,classids):
        print(lables_[j])
